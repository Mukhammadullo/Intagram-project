    ...
    <div className="ml-[50px] flex mt-[20px]">
      <div className="sidebar  h-[95vh] overflow-y-auto overflow-x-hidden px-[20px] w-[350px]">
        <div className="w-[285px] cursor-pointer hover:bg-[#EFEFEF] shadow-xl py-[20px] rounded-[15px] px-[20px]">
          ...
          >
            <title>
              Словесный знак и логотип семейства приложений Facebook
            </title>
            <defs>
              <linearGradient
          ...
          <p className="text-[13px] text-[#727272]">
            Управляйте кросс-сервисными <br /> функциями и настройками аккаунтов
            на <br /> платформах Meta.
          </p>
          ...
          <div className="">
            <h1 className="text-[#0095F6] text-[13px] pt-[10px] font-[600]">
        ...
        <div className="">
          ...
          <div className="px-[20px] cursor-pointer">
            <div onClick={()=> handleOpen2()} className="hover:bg-[#EFEFEF] px-[10px] py-[12px] rounded-[8px]">
            ...
            <div className=" px-[10px] py-[12px] rounded-[8px]">
              <p className="text-[14px] text-[#0095F6]">
        ...
        >
          <Box sx={style2}>
            <div className="flex flex-col text-center">
              ...
              <hr />
              <div className="hover:shadow-2xl transition-[1s] py-[10px]">
                <label
                  htmlFor="profilePic"
              ...
              <div className="hover:shadow-2xl transition-[1s] py-[10px]">
                <h1
                  onClick={() => {
                    dispatch(deletPhoto()), setOpen2(false);
                  }}
                  className="cursor-pointer font-[600] text-[#ED4956]"
                >
              ...
              <hr />
              <div className="hover:shadow-2xl transition-[1s] pt-[10px] pb-[15px]">
                <h1
                  className="cursor-pointer text-[#3b87ba] font-[600]"
                  onClick={() => {  
                    handleSubmit(), setOpen2(false);
                  }}
                >
